...
RUN hb-service update-node 20.10.0 --allow-root && \
    ...
    npm install -g homebridge-lg-thinq@v1.6.3 && \
    npm install -g github:ivan-garcia-parras/homebridge-eufy-security#feature/v2.3.1 && \
    npm install -g homebridge-webos-tv@v2.4.3 && \
